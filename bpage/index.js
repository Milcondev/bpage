...
class bpage{
    ...
    setTime(time) {
        ...
        this.bpageOptions.timeout = time;
        return this;
    }
    ...
    */
    ...
    setStyle(style) {
        ...
        switch (style) {
            case "primary":
                {
                    this.bpageOptions.style = ButtonStyle.Primary;
                    break;
                }

            case "danger":
                {
                    this.bpageOptions.style = ButtonStyle.Danger;
                    break;
                }
            case "success":
                {
                    this.bpageOptions.style = ButtonStyle.Success;
                    break;
                }
            case "secondary":
                {
                    this.bpageOptions.style = ButtonStyle.Secondary;
                    break;
                }
            default:
                {
    ...
    */
    ...
    setEmoji(options) {
        ...
        this.bpageOptions.emojis = options;
        return this;
    }
     ...
     * @param {bpageOptions} options 
     * @returns 
     */
    async bpage(interaction, embeds, options = this.bpageOptions) {
